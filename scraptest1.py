...
if __name__=="__main__":
    ...
    cls.download_users_profile_picture("max_.gonsalves")
    #cls.download_users_posts_with_periods("world_record_egg")
    #cls.download_hastag_posts("gadgets")
    #cls.get_users_followers("zendaya")
    #cls.get_users_followings("best_gadgets_2030")
    #cls.get_post_comments("rotaract_crce")
    #cls.get_post_info_csv("rotaract_crce")
